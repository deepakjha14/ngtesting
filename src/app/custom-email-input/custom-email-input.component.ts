...
const CHIPS_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => CustomEmailInputComponent),
  multi: true
};
...
@Component({
    ...
    styleUrls: ['./custom-email-input.component.scss']
})
export class CustomEmailInputComponent implements AfterContentInit,ControlValueAccessor {
...
//   exports: [CustomEmailInputComponent],
